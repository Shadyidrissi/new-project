...
const serviceData = [
  {
    ...
    form: (
      <Form
        title="build Full stack web"
        f="Function Web"
        list={["Hosting", "Domain Name", "Dashbord"]}
  ...
  },
  {
    languages: [
      ...
      <svg width="100" height="100" viewBox="0 0 512 512" class="h-full w-full">
        <rect
          width="512"
          height="512"
          x="0"
      ...
      >
        ...
        >
          <g fill="currentColor">
            <path
              fill="currentColor"
              d="M14.302 13.575c.033-.121.044-.253.044-.396v-.803c0-.11-.01-.242-.033-.352c-.12-.528-.55-.957-1.166-.957c-.869 0-1.353.77-1.353 1.771c0 .979.484 1.694 1.342 1.694c.55 0 1.034-.374 1.166-.957Z"
            />
            <path
              fill="currentColor"
              fill-rule="evenodd"
              d="M6.77 3.082a47.472 47.472 0 0 1 10.46 0c1.899.212 3.43 1.707 3.653 3.613a45.67 45.67 0 0 1 0 10.61c-.223 1.906-1.754 3.401-3.652 3.614a47.468 47.468 0 0 1-10.461 0c-1.899-.213-3.43-1.708-3.653-3.613a45.672 45.672 0 0 1 0-10.611C3.34 4.789 4.871 3.294 6.77 3.082Zm7.576 7.644V7.69H15.7v6.303c0 .55.022 1.144.044 1.507h-1.21l-.055-.847h-.022c-.319.594-.968.968-1.749.968c-1.276 0-2.288-1.089-2.288-2.739c-.01-1.793 1.111-2.86 2.398-2.86c.737 0 1.265.308 1.507.704h.022ZM8.355 15.5V8.086h1.353V15.5H8.355Z"
              clip-rule="evenodd"
            />
          </g>
        </svg>
        ...
        >
          <g fill="currentColor">
            <path
              fill="currentColor"
              fill-rule="evenodd"
              d="M12.75 15.373a3.999 3.999 0 0 0 6.195-4.654A3.999 3.999 0 0 0 17.582 9a3.996 3.996 0 0 0 1.668-3.25a4 4 0 0 0-4-4h-6.5A4 4 0 0 0 6.418 9a4 4 0 0 0 0 6.5a4 4 0 1 0 6.332 3.25v-3.377Zm-4-12.123a2.5 2.5 0 1 0 0 5h2.5v-5h-2.5Zm2.5 13h-2.5a2.5 2.5 0 1 0 2.5 2.5v-2.5Zm-2.5-6.5a2.5 2.5 0 0 0 0 5h2.5v-5h-2.5Zm4 2.5a2.5 2.5 0 1 0 5.001 0a2.5 2.5 0 0 0-5.001 0Zm2.5-4a2.5 2.5 0 1 0 0-5h-2.5v5h2.5Z"
              clip-rule="evenodd"
            />
          </g>
        </svg>
